...
// Invalid external declaration at AML offset 0x404 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^GFX0.IUER], AE_NOT_FOUND (20180427/dswload-498)
// Invalid external declaration at AML offset 0x41e (see bz1397).
//Firmware Error (ACPI): Failure looking up [^RP01.PXSX], AE_NOT_FOUND (20180427/dswload-498)
// Invalid external declaration at AML offset 0x44a (see bz1397).
//Firmware Error (ACPI): Failure looking up [^B0D4.GPL2], AE_NOT_FOUND (20180427/dswload-498)
// Invalid external declaration at AML offset 0x457 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^B0D4.GPL1], AE_NOT_FOUND (20180427/dswload-498)
// Invalid external declaration at AML offset 0x464 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^GFX0.CLID], AE_NOT_FOUND (20180427/dswload2-468)
// Invalid external declaration at AML offset 0x404 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^GFX0.IUER], AE_NOT_FOUND (20180427/dswload2-468)
// Invalid external declaration at AML offset 0x41e (see bz1397).
//Firmware Error (ACPI): Failure looking up [^RP01.PXSX], AE_NOT_FOUND (20180427/dswload2-468)
// Invalid external declaration at AML offset 0x44a (see bz1397).
//Firmware Error (ACPI): Failure looking up [^B0D4.GPL2], AE_NOT_FOUND (20180427/dswload2-468)
// Invalid external declaration at AML offset 0x457 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^B0D4.GPL1], AE_NOT_FOUND (20180427/dswload2-468)
// Invalid external declaration at AML offset 0x464 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^GFX0.CLID], AE_NOT_FOUND (20180427/dswload-498)
// Invalid external declaration at AML offset 0x404 (see bz1397).
//Firmware Error (ACPI): Failure looking up [^GFX0.IUER], AE_NOT_FOUND (20180427/dswload-498)
            ...
            Device (BAT0)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    If (ECON)
                    {
                        ...
                        If (FCC0)
                        {
                            BPKG [0x05] = ((FCC0 * BASC) / 0x0A)
                            BPKG [0x06] = ((FCC0 * BASC) / 0x19)
                            BPKG [0x07] = ((BDC0 * BASC) / 0x64)
                        }
