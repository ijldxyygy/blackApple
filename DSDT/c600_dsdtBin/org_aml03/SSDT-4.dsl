 ...
 *
 * Disassembly of acpi_ssdt04.aml, Thu May  4 20:29:44 2017
 *
...
DefinitionBlock ("", "SSDT", 1, "PmRef", "CpuPm", 0x00003000)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        Method (GCAP, 1, NotSerialized)
        {
            ...
            If (And (CFGD, One))
            {
                If (LAnd (LAnd (And (CFGD, 0x01000002), LEqual (And (PDC0, 0x09), 0x09)), LNot (And (SDTL, One))))
                {
                    Or (SDTL, One, SDTL)
            ...
            If (And (CFGD, 0xF0))
            {
                If (LAnd (LAnd (And (CFGD, 0x01000002), And (PDC0, 0x18)), LNot (And (SDTL, 0x02))))
                {
                    Or (SDTL, 0x02, SDTL)
